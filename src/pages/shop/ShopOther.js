...
const[amount, setAmount]= useState(1)
    ...
    const [datasPMF, setDatasPMF ] = useState([])
     ...
     const fetchData = async()=>{
        //讀取本頁資料，並寫入datas
        const response = await fetch('https://house-coffee-backend.herokuapp.com/shop/other');
        ...
        const PMF = await fetch(`https://house-coffee-backend.herokuapp.com/shop/wishlist?fk_m_id=${thismemberid}&fk_p_id=${results[i].p_id}`);
         ...
         ////console.log.log.log(results[i].p_id)
         ////console.log.log.log(PMF2.total)

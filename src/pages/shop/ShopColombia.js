...
const[amount, setAmount]= useState(1)
    ...
    const [datasPMF, setDatasPMF ] = useState([])
     ...
     const fetchData = async()=>{
        //讀取本頁資料，並寫入datas
        const response = await fetch('https://house-coffee-backend.herokuapp.com/shop/colombia');
                        ...
                        <div class="row" >
                            ...
                            <div class="type">
                                ...
                                required>
                                    ...
                                    <option value="colombia" selected>哥倫比亞</option>

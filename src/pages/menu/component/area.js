...
function Area(props){
    ...
    const fetchData=async()=>{
        const response = await fetch(`https://house-coffee-backend.herokuapp.com/menu/area`)
    ...
    const CGArea=async()=>{
        ...
        const response = await fetch(`https://house-coffee-backend.herokuapp.com/menu/areastore?city=${area2}`)
        const results=await response.json();

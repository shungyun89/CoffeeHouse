...
const MenuCardRwd = (props) => {
    ...
    if(thisURL=='https://coffee-house-ko04f9xzv-shungyun89.vercel.app/onlinemenu'){
        return(
                <>
                    {/* 印出資料 */}
                    {datas.map((mu,i)=>{
...
}else if(thisURL=='https://coffee-house-ko04f9xzv-shungyun89.vercel.app/favorite'){
    return(
        <>
            {/* 印出資料 */}
            {favdatas.map((mu,i)=>{
...
}else if(thisURL=='https://coffee-house-ko04f9xzv-shungyun89.vercel.app/MenuTypeToday'){
    return(
        <>
            {/* 印出資料 */}
            {todaydatas.map((mu,i)=>{
...
}else if(thisURL=='https://coffee-house-ko04f9xzv-shungyun89.vercel.app/MenuTypeIce'){
    return(
        <>
            {/* 印出資料 */}
            {icedatas.map((mu,i)=>{
...
}else if(thisURL=='https://coffee-house-ko04f9xzv-shungyun89.vercel.app/MenuTypeHot'){
    return(
        <>
            {/* 印出資料 */}
            {hotdatas.map((mu,i)=>{
